...
<header class="header main <?= ($_SERVER['REQUEST_URI'] != '/') ? 'colorized' : '';?>">
    <nav class="nav container">
        <ul class="nav-menu">
            <li><a href="/" class="menu-item">
                    <svg data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" class="logo" viewBox="0 0 391.76 132.38"><title>
                            magiclogo</title>
            ...
            <li class="action-reg">
                ...
                <button class="menu-item btn login">Вход</button>
                <button class="menu-item btn btn-transparent register">Регистрация</button>
                <? else: ?>
                    <a class="menu-item btn btn-blue-gradient" href="/<?= $_COOKIE['role']?>/index/<?= $_COOKIE['id']?>">Личный кабинет</a>
                    <a class="menu-item btn btn-transparent" href="/account/logout/">Выход</a>
                <? endif;?>
            </li>
        </ul>
    </nav>
