...
<nav class="main-menu">
    <ul class="menu-items">
        <li class="menu-item">
            <a class="menu-link" href="/user/index/<?= $_COOKIE['id']?>">
                <i class="fal fa-user"></i>
                <span class="nav-text">Профиль</span>
            </a>
        </li>
        <li class="menu-item">
                <a class="menu-link" href="/user/<?= $_COOKIE['id']?>/attachment/<?= Common::getValue($data, 'id');?>">
                    <i class="far fa-hand-holding-usd"></i>
                    <span class="nav-text">Мои вклады</span>
                </a>
        </li>
    </ul>
