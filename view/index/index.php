...
<div class="grid-col-6 header-box">
    <canvas class="canvas-dollar"></canvas>
    <div class="block-items container">
        <div class="block-item block-item--text">
            <span class="item-text">Меньше вкладываешь — больше получаешь!</span>
        </div>
    </div>
</div>

<section class="grid-col-6 container">
    <div class="items-box">
        <header class="items-header">
            <ul class="tabs-link">
                <li><a href="#tab-1" class="tabs-target">Вклады и счета</a></li>
                <li><a href="#tab-2" class="tabs-target">Подобрать вклад</a></li>
            </ul>
        </header>
        <div class="tabs-box">
            <div class="tabs-items" id="tab-1">
                <?php $contr = $data['contributions'];
                foreach ($contr as $key => $value):
                    ?>
                    <div class="item">
                        <header class="item-header">
                            <h2 class="title">Вклад «<?php echo $value['name'] ?>»</h2>
                        </header>
                        <div class="item-body">
                            <p>
                            ...
                            <div class="item-info">
                                <span>Ставка: до <?php echo $value['percent'] ?>%</span>
                                <span>Сумма вклада: от <?php echo $value['minimum-money'] ?> руб</span>
                                <span>Срок: до <?php echo $value['year'] ?> лет</span>
                            </div>
                            <div class="item-info">
                                <span class="txt-gray">Пополнение и снятие вклада</span>
                                <span>
                                        <?php echo ($value['replenished']) ? "<i class=\"far fa-check\"></i>пополняемый" : "<i class=\"fal fa-times\"></i>не пополняемый"; ?>
                                    </span>
                                <span>
                                         <?php echo ($value['taken']) ? "<i class=\"far fa-check\"></i>снимаемый" : "<i class=\"fal fa-times\"></i>не снимаемый"; ?>
                                    </span>
                            </div>
                        </div>
                        <footer class="item-footer">

                            <a class="btn btn-gradient" href="/contribution/add/<?= $value['id'] ?>">Рассчитать</a>

                        </footer>
                    </div>
                <?php endforeach; ?>
            </div>
            <div class="tabs-items" id="tab-2">
                <div class="item">fasdasd</div>
            </div>
        </div>
    </div>
</section>

<section class="grid-col-6 progress">
    <div class="grid container">
        <div class="progress-item">
            <div class="circle">
                <i class="fal fa-lock-alt"></i>
            </div>
            <span>Надёжное хранение</span>
        </div>
        <div class="progress-item">
            <div class="circle">
                <i class="fal fa-globe"></i>
            </div>
            <span>Удобный веб-интерфейс</span>
        </div>
        <div class="progress-item">
            <div class="circle">
        ...
        <div class="progress-item">
            ...
            <span>Выплата процентов ежемесячно</span>
        </div>
    </div>
</section>
<section class="grid-col-6 container">
    ...
    <div class="grid-coladd-3">
        <div class="cart">
            <header class="cart-header">
                    <span class="circle"
                          style="background-image: url('/assets/img/1.jpeg')"></span>
                <span class="name">Наталья</span>
            </header>
            <div class="body">
                <p>
                    Замечтальный банк!
                    Советую всем друзьям
                </p>
            </div>
        </div>
        <div class="cart">
            <header class="cart-header">
                    <span class="circle"
                          style="background-image: url('/assets/img/user1.jpg')"></span>
                <span class="name">Олег</span>
            </header>
            <div class="body">
                <p>
                    Уже длительное время пользуюсь услугами этого банка. Очень радует, что можно вкладывать и
                    следить за счётом онлайн.
                </p>
            </div>
        </div>
        <div class="cart">
            <header class="cart-header">
                    <span class="circle"
                          style="background-image: url('/assets/img/user.jpg')"></span>
                <span class="name">Георгий</span>
            </header>
            <div class="body">
                <p>
                    Можно не беспокоится за свои
                    средства. Положил 5000, а забрал 90 000.
                </p>
            </div>
        </div>
    </div>
